...
public class mrPresident {
    ...
    public static int mrpresident(int n, int[][] edges, long k){
        ...
        ArrayList<Integer> mstWeightEdges = new ArrayList<>();
        ...
        int transform = 0;
        for(int i = mstWeightEdges.size() - 1; i >= 0; i--){
            overallWeightSum = overallWeightSum - mstWeightEdges.get(i) + 1;
            transform++;
    ...
    public static void mrpresident() throws Exception {
        int n = sc.nextInt();
        int m = sc.nextInt();
        long k = sc.nextLong();
